...
dados_alunos_curso_disciplinas = []
...
#               break
            ...
            try:
                ...
                if all(field in json_data for field in [
                    'Curso',
                    ...
                    dados_alunos_curso_disciplinas.append(json_data)
...
if dados_alunos_curso_disciplinas:
    # Cria um DataFrame do Pandas com os dados lidos
    df = pd.DataFrame(dados_alunos_curso_disciplinas)

    # Gera o nome do arquivo com base na data e hora atual
    current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
    arquivo_local = f'/usr/local/datasets/dados_alunos_curso_disciplinas_{current_time}.csv'
    arquivo_datalake = f'raw/dados_faculdade/dados_alunos_curso_disciplinas/dados_alunos_curso_disciplinas_{current_time}.csv'
