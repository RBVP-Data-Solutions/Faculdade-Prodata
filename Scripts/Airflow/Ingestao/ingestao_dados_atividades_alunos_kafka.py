...
#               break
            ...
            try:
                ...
                if all(field in json_data for field in [
                    ...
                    dados_atividades_alunos.append(json_data)
...
if dados_atividades_alunos:
    # Cria um DataFrame do Pandas com os dados lidos
    df = pd.DataFrame(dados_atividades_alunos)

    # Gera o nome do arquivo com base na data e hora atual
    current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
    arquivo_local = f'/usr/local/datasets/dados_atividades_alunos_{current_time}.csv'
    arquivo_datalake = f'raw/dados_faculdade/dados_atividades_alunos/dados_atividades_alunos_{current_time}.csv'
