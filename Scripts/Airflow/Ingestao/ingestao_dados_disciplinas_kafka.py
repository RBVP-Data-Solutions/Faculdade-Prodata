...
#               break
            ...
            try:
                ...
                if all(field in json_data for field in ['Código da Disciplina', 'Curso', 'Nome da Disciplina', 'Tipo', 'Nota de Corte', 'Carga Horária Prevista', 'Frequência Mínima']):
...
if dados_disciplinas:
    ...
    arquivo_local = f'/usr/local/datasets/dados_disciplinas_{current_time}.csv'
    arquivo_datalake = f'raw/dados_faculdade/dados_disciplinas/dados_disciplinas_{current_time}.csv'
